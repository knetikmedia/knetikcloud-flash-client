...
public class StoreApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function create_item_template_using_post (itemTemplateResource: ItemTemplateResource): String {
...
if("null" != String(order))
        ...
        token.returnType = PageStoreItem;
        return requestId;
     ...
     * Returns void 
     */
    public function update_item_template_using_put (id: String, itemTemplateResource: ItemTemplateResource): String {
        // create path and map variables
        var path: String = "/store/items/templates/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
