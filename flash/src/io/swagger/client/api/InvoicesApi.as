...
public class InvoicesApi extends SwaggerApi {
    ...
    */
    public function InvoicesApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_list_ful_fillment_statuses: String = "list_ful_fillment_statuses";
        public static const event_list_payment_statuses: String = "list_payment_statuses";
...
if("null" != String(page))
     ...
     */
    public function get_invoices (filterUser: Number, filterEmail: String, filterFulfillmentStatus: String, filterPaymentStatus: String, filterItemName: String, filterCreatedDate: String, size: Number, page: Number, order: String): String {
        // create path and map variables
        var path: String = "/invoices".replace(/{format}/g,"xml");
...
if("null" != String(order))
     ...
     * Returns Array 
     */
    public function list_ful_fillment_statuses (): String {
        // create path and map variables
        ...
        token.requestId = requestId;
        token.completionEventType = "list_ful_fillment_statuses";
     ...
     * Returns Array 
     */
    public function list_payment_statuses (): String {
        // create path and map variables
        ...
        token.requestId = requestId;
        token.completionEventType = "list_payment_statuses";
