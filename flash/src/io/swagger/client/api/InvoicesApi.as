...
if("null" != String(page))
     ...
     */
    public function get_invoices (filterUser: Number, filterEmail: String, filterFulfillmentStatus: String, filterPaymentStatus: String, filterItemName: String, filterExternalRef: String, filterCreatedDate: String, filterVendorIds: String, filterCurrency: String, filterShippingStateName: String, filterShippingCountryName: String, filterShipping: Number, filterVendorName: String, filterSku: String, size: Number, page: Number, order: String): String {
        // create path and map variables
        var path: String = "/invoices".replace(/{format}/g,"xml");
