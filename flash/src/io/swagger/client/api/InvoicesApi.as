...
if("null" != String(page))
     ...
     */
    public function get_invoices (filterUser: Number, filterEmail: String, filterFulfillmentStatus: String, filterPaymentStatus: String, filterItemName: String, filterExternalRef: String, filterCreatedDate: String, size: Number, page: Number, order: String): String {
        // create path and map variables
        var path: String = "/invoices".replace(/{format}/g,"xml");
