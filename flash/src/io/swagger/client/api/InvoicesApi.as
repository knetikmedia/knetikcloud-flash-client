...
if("null" != String(order))
        ...
        token.returnType = PageInvoiceResource;
        return requestId;
     ...
     */
    public function get_invoice_using_get (id: Number, postalCode: String): String {
        // create path and map variables
        ...
        if("null" != String(postalCode))
            queryParams["postalCode"] = toPathValue(postalCode);
...
if("null" != String(page))
        ...
        token.returnType = PageInvoiceLogEntry;
        return requestId;
