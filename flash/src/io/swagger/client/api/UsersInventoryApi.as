...
public class UsersInventoryApi extends SwaggerApi {
    ...
    */
    public function UsersInventoryApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_get_user_inventory1: String = "get_user_inventory1";
        public static const event_get_user_inventory_log: String = "get_user_inventory_log";
        public static const event_get_user_inventory_log1: String = "get_user_inventory_log1";
     ...
     */
    public function create_entitlement_item (entitlementItem: EntitlementItem): String {
        // create path and map variables
     ...
     */
    public function get_entitlement_items (size: Number, page: Number, order: String): String {
        // create path and map variables
        var path: String = "/entitlements".replace(/{format}/g,"xml");
...
if("null" != String(order))
     ...
     */
    public function get_user_inventory1 (id: Number, inactive: Boolean, size: Number, page: Number, filterItemName: String, filterMinDate: Number, filterMaxDate: Number): String {
        // create path and map variables
        var path: String = "/users/{id}/inventory".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
...
if("null" != String(filterMaxDate))
        ...
        token.requestId = requestId;
        token.completionEventType = "get_user_inventory1";
...
if("null" != String(page))
     ...
     * Returns void 
     */
    public function get_user_inventory_log1 (userId: Number, id: Number, timestamp: Number): String {
        // create path and map variables
        ...
        token.requestId = requestId;
        token.completionEventType = "get_user_inventory_log1";
     ...
     * Returns PageResourceUserInventoryResource 
     */
    public function get_users_inventory (inactive: Boolean, size: Number, page: Number, filterItemName: String, filterUsername: String, filterGroup: String, filterDate: String): String {
        // create path and map variables
...
if("null" != String(filterDate))
     ...
     * Returns void 
     */
    public function update_entitlement_item (entitlementId: Number, entitlementItem: EntitlementItem): String {
        // create path and map variables
        var path: String = "/entitlements/{entitlement_id}".replace(/{format}/g,"xml").replace("{" + "entitlementId" + "}", getApiInvoker().escapeString(entitlementId));
