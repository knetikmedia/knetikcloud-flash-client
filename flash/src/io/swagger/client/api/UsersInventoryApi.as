...
if("null" != String(order))
     ...
     */
    public function get_user_inventories (id: Number, inactive: Boolean, size: Number, page: Number, filterItemName: String, filterMinDate: Number, filterMaxDate: Number): String {
        // create path and map variables
        var path: String = "/users/{id}/inventory".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
