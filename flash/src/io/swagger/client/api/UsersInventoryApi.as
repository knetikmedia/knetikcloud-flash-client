...
public class UsersInventoryApi extends SwaggerApi {
    ...
    */
    public function UsersInventoryApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_create_template_using_post3: String = "create_template_using_post3";
        public static const event_delete_entitlement_template_using_delete: String = "delete_entitlement_template_using_delete";
        ...
        public static const event_get_entitlement_template_using_get: String = "get_entitlement_template_using_get";
        public static const event_get_entitlement_templates_using_get: String = "get_entitlement_templates_using_get";
        ...
        public static const event_grant_entitlement_using_post: String = "grant_entitlement_using_post";
        public static const event_update_item_using_put1: String = "update_item_using_put1";
        public static const event_update_template_using_put3: String = "update_template_using_put3";
     ...
     */
    public function create_template_using_post3 (template: ItemTemplateResource): String {
        // create path and map variables
        ...
        token.requestId = requestId;
        token.completionEventType = "create_template_using_post3";
     ...
     * Returns void 
     */
    public function delete_entitlement_template_using_delete (id: String, cascade: String): String {
        // create path and map variables
        ...
        token.requestId = requestId;
        token.completionEventType = "delete_entitlement_template_using_delete";
...
if("null" != String(order))
     ...
     * Returns ItemTemplateResource 
     */
    public function get_entitlement_template_using_get (id: String): String {
        // create path and map variables
        var path: String = "/entitlements/templates/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
        ...
        token.requestId = requestId;
        token.completionEventType = "get_entitlement_template_using_get";
     ...
     */
    public function get_entitlement_templates_using_get (size: Number, page: Number, order: String): String {
        // create path and map variables
        var path: String = "/entitlements/templates".replace(/{format}/g,"xml");
...
if("null" != String(order))
        ...
        token.requestId = requestId;
        token.completionEventType = "get_entitlement_templates_using_get";
     ...
     */
    public function get_inventory_list_using_get (inactive: Boolean, size: Number, page: Number, filterItemName: String, filterUsername: String, filterGroup: String, filterDate: String): String {
        // create path and map variables
...
if("null" != String(page))
     ...
     * Returns void 
     */
    public function grant_entitlement_using_post (userId: Number, grantRequest: EntitlementGrantRequest): String {
        // create path and map variables
        ...
        token.requestId = requestId;
        token.completionEventType = "grant_entitlement_using_post";
     ...
     * Returns void 
     */
    public function update_template_using_put3 (id: String, template: ItemTemplateResource): String {
        // create path and map variables
        var path: String = "/entitlements/templates/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
        ...
        token.requestId = requestId;
        token.completionEventType = "update_template_using_put3";
