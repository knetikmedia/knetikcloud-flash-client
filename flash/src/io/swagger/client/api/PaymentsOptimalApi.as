...
public class PaymentsOptimalApi extends SwaggerApi {
    ...
    */
    public function PaymentsOptimalApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_silent_post_using_post: String = "silent_post_using_post";


    /*
     * Returns String 
     */
    public function silent_post_using_post (request: OptimalPaymentRequest): String {
        ...
        token.completionEventType = "silent_post_using_post";
