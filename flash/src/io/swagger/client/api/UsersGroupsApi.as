...
public class UsersGroupsApi extends SwaggerApi {
    ...
    */
    public function UsersGroupsApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_delete_group_using_delete1: String = "delete_group_using_delete1";
     ...
     * Returns void 
     */
    public function delete_group_using_delete (uniqueName: String, userId: Number): String {
        // create path and map variables
     ...
     * Returns void 
     */
    public function delete_group_using_delete1 (uniqueName: String): String {
        // create path and map variables
        ...
        token.requestId = requestId;
        token.completionEventType = "delete_group_using_delete1";
...
if("null" != String(order))
        ...
        token.returnType = PageGroupMemberResource;
        return requestId;
...
if("null" != String(order))
        ...
        token.returnType = PageGroupResource;
        return requestId;
