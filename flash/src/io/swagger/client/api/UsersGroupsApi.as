...
public class UsersGroupsApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function add_member_to_group (uniqueName: String, username: GroupMemberResource): String {
...
if("null" != String(order))
     ...
     */
    public function update_groups (filterName: String, filterUniqueName: String, filterParent: String, size: Number, page: Number, order: String): String {
        // create path and map variables
        var path: String = "/users/groups".replace(/{format}/g,"xml");
