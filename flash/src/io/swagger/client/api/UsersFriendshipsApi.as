...
public class UsersFriendshipsApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function get_friends (userId: String, size: Number, page: Number, order: String): String {
        // create path and map variables
...
if("null" != String(order))
     ...
     * Returns PageResourceSimpleUserResource 
     */
    public function get_invites (userId: String, size: Number, page: Number, order: String): String {
        // create path and map variables
