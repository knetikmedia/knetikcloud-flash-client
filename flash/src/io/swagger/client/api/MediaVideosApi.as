...
public class MediaVideosApi extends SwaggerApi {
    ...
    */
     ...
     * Returns void 
     */
    public function delete_relationship_using_delete (videoId: Number, id: Number): String {
        // create path and map variables
...
if("null" != String(page))
        ...
        token.returnType = PageDispositionResource;
        return requestId;
...
if("null" != String(page))
        ...
        token.returnType = PageVideoRelationshipResource;
        return requestId;
...
if("null" != String(page))
        ...
        token.returnType = PageVideoResource;
        return requestId;
...
if("null" != String(order))
     ...
     * Returns void 
     */
    public function update_relationship_using_put (videoId: Number, relationshipId: Number, details: String): String {
        // create path and map variables
