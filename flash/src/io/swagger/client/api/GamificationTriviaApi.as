...
public class GamificationTriviaApi extends SwaggerApi {
    ...
    */
    public function GamificationTriviaApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_get_question_tags1: String = "get_question_tags1";
...
if("null" != String(order))
     ...
     */
    public function get_question_tags1 (filterSearch: String, filterCategory: String, filterImportId: Number): String {
        // create path and map variables
...
if("null" != String(filterImportId))
        ...
        token.requestId = requestId;
        token.completionEventType = "get_question_tags1";
...
if("null" != String(order))
     ...
     */
    public function get_questions (size: Number, page: Number, order: String, filterSearch: String, filterIdset: String, filterCategory: String, filterTagset: String, filterType: String, filterPublished: Boolean, filterImportId: Number): String {
        // create path and map variables
        var path: String = "/trivia/questions".replace(/{format}/g,"xml");
