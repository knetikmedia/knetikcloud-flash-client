...
public class UtilHealthApi extends SwaggerApi {
    ...
    */
    public function UtilHealthApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_get_health_info_using_get: String = "get_health_info_using_get";


    /*
     * Returns Object 
     */
    public function get_health_info_using_get (): String {
        ...
        token.completionEventType = "get_health_info_using_get";
