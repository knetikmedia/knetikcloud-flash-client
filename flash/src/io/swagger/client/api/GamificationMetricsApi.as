...
public class GamificationMetricsApi extends SwaggerApi {
    ...
    */
    public function GamificationMetricsApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_add_metric_using_post: String = "add_metric_using_post";


    /*
     * Returns void 
     */
    public function add_metric_using_post (metric: MetricResource): String {
        ...
        token.completionEventType = "add_metric_using_post";
