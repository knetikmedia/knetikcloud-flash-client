...
if("null" != String(order))
     ...
     * Returns PageResourceWalletTransactionResource 
     */
    public function get_wallet_transactions (filterInvoice: Number, filterType: String, filterDate: String, filterSign: String, filterUserId: Number, filterUsername: String, filterDetails: String, filterCurrencyCode: String, size: Number, page: Number, order: String): String {
        // create path and map variables
