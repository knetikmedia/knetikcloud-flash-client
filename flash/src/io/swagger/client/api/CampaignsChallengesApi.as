...
if("null" != String(order))
     ...
     */
    public function get_challenges (filterTemplate: Boolean, filterActiveCampaign: Boolean, filterStartDate: String, filterEndDate: String, size: Number, page: Number, order: String): String {
        // create path and map variables
        var path: String = "/challenges".replace(/{format}/g,"xml");
