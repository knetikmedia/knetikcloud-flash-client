...
public class PaymentsAppleApi extends SwaggerApi {
    ...
    */
    public function PaymentsAppleApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_verify_apple_receipt: String = "verify_apple_receipt";


    /*
     * Returns String 
     */
    public function verify_apple_receipt (request: ApplyPaymentRequest): String {
        ...
        token.completionEventType = "verify_apple_receipt";
