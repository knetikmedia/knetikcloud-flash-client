...
if("null" != String(order))
     ...
     */
    public function get_users (filterDisplayname: String, filterEmail: String, filterFirstname: String, filterFullname: String, filterLastname: String, filterUsername: String, filterTag: String, filterGroup: String, filterRole: String, filterLastActivity: String, filterIdList: String, filterSearch: String, size: Number, page: Number, order: String): String {
        // create path and map variables
...
if("null" != String(filterLastActivity))
            queryParams["filter_last_activity"] = toPathValue(filterLastActivity);
if("null" != String(filterIdList))
            queryParams["filter_id_list"] = toPathValue(filterIdList);
