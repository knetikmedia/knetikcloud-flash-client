...
if("null" != String(order))
     ...
     */
    public function get_users_using_get (filterRole: String, filterDisplayname: String, filterEmail: String, filterFirstname: String, filterFullname: String, filterLastname: String, filterUsername: String, filterTag: String, filterGroup: String, size: Number, page: Number, order: String): String {
        // create path and map variables
...
if("null" != String(order))
        ...
        token.returnType = PageUserBaseResource;
        return requestId;
