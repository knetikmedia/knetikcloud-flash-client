...
public class PaymentsXsollaApi extends SwaggerApi {
    ...
    */
    public function PaymentsXsollaApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_receive_xsolla_notification: String = "receive_xsolla_notification";
     ...
     * Returns void 
     */
    public function receive_xsolla_notification (): String {
        // create path and map variables
        ...
        token.requestId = requestId;
        token.completionEventType = "receive_xsolla_notification";
