...
public class AWSS3Api extends SwaggerApi {
    ...
    */
    public function AWSS3Api(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_pre_sign_url_using_get: String = "pre_sign_url_using_get";


    /*
     * Returns AmazonS3Activity 
     */
    public function pre_sign_url_using_get (filename: String, contentType: String): String {
...
if("null" != String(contentType))
        ...
        token.completionEventType = "pre_sign_url_using_get";
