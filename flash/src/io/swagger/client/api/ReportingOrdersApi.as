...
public class ReportingOrdersApi extends SwaggerApi {
    ...
    */
    public function ReportingOrdersApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_get_daily_invoices_using_get: String = "get_daily_invoices_using_get";


    /*
     * Returns PageAggregateInvoiceReportResource 
     */
    public function get_daily_invoices_using_get (currencyCode: String, granularity: String, filterPaymentStatus: String, filterFulfillmentStatus: String, startDate: Number, endDate: Number): String {
...
if("null" != String(endDate))
        ...
        token.completionEventType = "get_daily_invoices_using_get";

        token.returnType = PageAggregateInvoiceReportResource;
        return requestId;
