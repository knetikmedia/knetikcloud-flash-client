...
public class BRERuleEngineEventsApi extends SwaggerApi {
    ...
    */
     ...
     * Returns void 
     */
    public function fire_event_using_post (breEvent: BreEvent, authentication: OAuth2Authentication): String {
        ...
        var token:AsyncToken = getApiInvoker().invokeAPI(path, "POST", queryParams, authentication, headerParams);
