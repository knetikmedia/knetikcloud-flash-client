...
public class StoreShippingApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function create_shipping_item (cascade: Boolean, shippingItem: ShippingItem): String {
...
if("null" != String(order))
     ...
     * Returns ShippingItem 
     */
    public function update_shipping_item (id: Number, cascade: Boolean, shippingItem: ShippingItem): String {
        // create path and map variables
        var path: String = "/store/shipping/{id}".replace(/{format}/g,"xml").replace("{" + "id" + "}", getApiInvoker().escapeString(id));
