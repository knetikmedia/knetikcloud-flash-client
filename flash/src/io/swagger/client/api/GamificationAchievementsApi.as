...
if("null" != String(order))
     ...
     */
    public function get_achievements_using_get (filterTagset: String, filterName: String, filterHidden: Boolean, size: Number, page: Number, order: String): String {
        // create path and map variables
        var path: String = "/achievements".replace(/{format}/g,"xml");
...
if("null" != String(order))
     ...
     */
    public function get_all_user_progress_for_achievement_using_get (achievementName: String, filterAchievementTagset: String, filterAchievementHidden: Boolean, size: Number, page: Number): String {
        // create path and map variables
...
if("null" != String(page))
        ...
        token.returnType = PageUserAchievementResource;
        return requestId;
     ...
     * Returns PageUserAchievementResource 
     */
    public function get_all_user_progress_using_get (filterAchievementTagset: String, filterAchievementName: String, filterAchievementHidden: Boolean, size: Number, page: Number): String {
        // create path and map variables
...
if("null" != String(page))
    ...
    public function get_user_progress_for_achievement_using_get (userId: Number, achievementName: String): String {
        ...
        token.returnType = UserAchievementResource;
        return requestId;
     ...
     * Returns PageUserAchievementResource 
     */
    public function get_user_progress_using_get (userId: Number, filterAchievementTagset: String, filterAchievementName: String, filterAchievementHidden: Boolean, size: Number, page: Number): String {
        // create path and map variables
