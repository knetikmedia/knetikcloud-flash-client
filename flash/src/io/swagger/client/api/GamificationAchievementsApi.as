...
public class GamificationAchievementsApi extends SwaggerApi {
    ...
    */
    public function GamificationAchievementsApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_update_achievement_progress: String = "update_achievement_progress";
...
if("null" != String(order))
     ...
     */
    public function get_achievements (filterTagset: String, filterName: String, filterHidden: Boolean, filterDerived: Boolean, size: Number, page: Number, order: String): String {
        // create path and map variables
        var path: String = "/achievements".replace(/{format}/g,"xml");
...
if("null" != String(order))
     ...
     */
    public function get_user_achievements_progress (userId: Number, filterAchievementDerived: Boolean, filterAchievementTagset: String, filterAchievementName: String, filterAchievementHidden: Boolean, size: Number, page: Number): String {
        // create path and map variables
...
if("null" != String(page))
     ...
     * Returns PageResourceUserAchievementGroupResource 
     */
    public function get_users_achievement_progress (achievementName: String, filterAchievementDerived: Boolean, filterAchievementTagset: String, filterAchievementHidden: Boolean, size: Number, page: Number): String {
        // create path and map variables
...
if("null" != String(page))
     ...
     * Returns PageResourceUserAchievementGroupResource 
     */
    public function get_users_achievements_progress (filterAchievementDerived: Boolean, filterAchievementTagset: String, filterAchievementName: String, filterAchievementHidden: Boolean, size: Number, page: Number): String {
        // create path and map variables
...
if("null" != String(page))
     ...
     * Returns UserAchievementGroupResource 
     */
    public function update_achievement_progress (userId: Number, achievementName: String, request: AchievementProgressUpdateRequest): String {
        // create path and map variables
        var path: String = "/users/{user_id}/achievements/{achievement_name}".replace(/{format}/g,"xml").replace("{" + "userId" + "}", getApiInvoker().escapeString(userId)).replace("{" + "achievementName" + "}", getApiInvoker().escapeString(achievementName));
        ...
        token.requestId = requestId;
        token.completionEventType = "update_achievement_progress";
