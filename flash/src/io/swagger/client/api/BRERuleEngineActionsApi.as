...
public class BRERuleEngineActionsApi extends SwaggerApi {
    ...
    */
    public function BRERuleEngineActionsApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_get_actions_using_get: String = "get_actions_using_get";


    /*
     * Returns Array 
     */
    public function get_actions_using_get (filterCategory: String, filterName: String): String {
...
if("null" != String(filterName))
        ...
        token.completionEventType = "get_actions_using_get";
