...
public class LogsApi extends SwaggerApi {
    ...
    */
     ...
     */
    public function get_bre_event_logs (filterStartDate: String, filterEventName: String, size: Number, page: Number, order: String): String {
        // create path and map variables
...
if("null" != String(order))
     ...
     */
    public function get_user_logs (filterUser: Number, filterActionName: String, size: Number, page: Number): String {
        // create path and map variables
        var path: String = "/audit/logs".replace(/{format}/g,"xml");
