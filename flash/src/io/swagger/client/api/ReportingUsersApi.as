...
public class ReportingUsersApi extends SwaggerApi {
    ...
    */
    public function ReportingUsersApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_executive_revenue_item_sales_using_get1: String = "executive_revenue_item_sales_using_get1";


    /*
     * Returns PageAggregateCountResource 
     */
    public function executive_revenue_item_sales_using_get1 (granularity: String, startDate: Number, endDate: Number): String {
...
if("null" != String(endDate))
        ...
        token.completionEventType = "executive_revenue_item_sales_using_get1";

        token.returnType = PageAggregateCountResource;
        return requestId;
