...
public class StoreSubscriptionsApi extends SwaggerApi {
    ...
    */
    public function StoreSubscriptionsApi(apiCredentials: ApiUserCredentials, eventDispatcher: EventDispatcher = null) {
        ...
        public static const event_list_billing_reports_using_get: String = "list_billing_reports_using_get";
...
if("null" != String(order))
     ...
     */
    public function list_billing_reports_using_get (size: Number, page: Number): String {
        // create path and map variables
        var path: String = "/subscriptions/reports".replace(/{format}/g,"xml");
...
if("null" != String(page))
        ...
        token.requestId = requestId;
        token.completionEventType = "list_billing_reports_using_get";

        token.returnType = PageBillingReport;
        return requestId;
