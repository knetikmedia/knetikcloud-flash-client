...
import io.swagger.client.model.TopicSubscriber;
    ...
    [XmlRootNode(name="WebsocketUnsubscribeEvent")]
    public class WebsocketUnsubscribeEvent {
        ...
        public var topic: Topic = NaN;
                [XmlElement(name="topic_subscriber")]
        public var topicSubscriber: TopicSubscriber = NaN;

    public function toString(): String {
        var str: String = "WebsocketUnsubscribeEvent: ";
        str += " (client: " + client + ")";
        ...
        str += " (type: " + type + ")";
        str += " (topic: " + topic + ")";
        str += " (topicSubscriber: " + topicSubscriber + ")";
        return str;
    }
